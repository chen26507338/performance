...
public class AssessNormPoint extends BaseModel<AssessNormPoint> {
    ...
    * 人员配置校级分
    */
    @TableField("rypz_main")
    private Double rypzMain;

    /**
    * 人员配置院级分
    */
    @TableField("rypz_college")
    private Double rypzCollege;

    /**
    * 竞赛获奖校积分
    */
    @TableField("jshj_main")
    private Double jshjMain;

    /**
    * 竞赛获奖院级分
    */
    @TableField("jshj_college")
    private Double jshjCollege;
    /**
    * 专项工作校积分
    */
    @TableField("zxgz_main")
    private Double zxgzMain;

    /**
    * 专项工作院级分
    */
    @TableField("zxgz_college")
    private Double zxgzCollege;

    /**
    * 社会培训工作校积分
    */
    @TableField("shpxgz_main")
    private Double shpxgzMain;

    /**
    * 社会培训工作院级分
    */
    @TableField("shpxgz_college")
    private Double shpxgzCollege;

    /**
    * 经费完成情况校积分
    */
    @TableField("jfwcqk_main")
    private Double jfwcqkMain;

    /**
    * 经费完成情况院级分
    */
    @TableField("jfwcqk_college")
    private Double jfwcqkCollege;
